...
- **Insertion EFX exists as a block, and eight of its sixty-five algorithms do.** ts::InsertionEffect
  ...
  **Distortion** (`01 11`), **Rotary** (`01 22`), **Reverb** (`01 55`) and **OD / OD2** (`11 03`); Overdrive and Distortion
  are one dataflow that differs only in its presets, which is how the decompiled functions differ.
  The other **57 pass the signal through** unchanged, with routing and send levels still honoured,
